...
PHP1_VERSION=$(grep -w "php1_version" "/var/tinycp/.hostvn.conf" | cut -f2 -d'=')
PHP2_RELEASE=$(grep -w "php2_release" "/var/tinycp/.hostvn.conf" | cut -f2 -d'=')
PHP2_VERSION=$(grep -w "php2_version" "/var/tinycp/.hostvn.conf" | cut -f2 -d'=')
